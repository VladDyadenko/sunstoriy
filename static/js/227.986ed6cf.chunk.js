"use strict";(self.webpackChunksunstoriy=self.webpackChunksunstoriy||[]).push([[227],{2288:(e,t,n)=>{n.d(t,{A:()=>L});var i=n(5475),o=n(5043),r=n(9783),s=n(2252),a=n(945),l=n(1529),d=n(2127);const c=l.Ay.ul`
  width: 50px;
  display: block;
  padding: 0 5px;
  margin-right: 10px;
...
`;var l=n(9783),d=n(579);const c=e=>{let{pageName:t}=e;const n=JSON.stringify({office:t});return(0,d.jsxs)(s,{children:[(0,d.jsx)(a,{children:"\u0414\u043e\u0434\u0430\u0442\u0438 \u0443\u0440\u043e\u043a:"}),(0,d.jsx)(r,{to:`/lesson?lessonCopy=${n}`,children:(0,d.jsx)(l.A,{})})]})}},9227:(e,t,n)=>{n.r(t),n.d(t,{default:()=>y});var i=n(9456),o=n(5043),r=n(446),s=n.n(r),a=n(93),l=n(6581),d=n(2012),c=n(9615),p=n(2288),x=n(7583),u=n(433),m=n(4502),f=n(7784),h=n(8234),g=n(579);const y=function(){const e=(0,i.d4)(x.eu),[t,n]=(0,o.useState)(null),[r,y]=(0,o.useState)([]),[b,v]=(0,o.useState)(null),[w,j]=(0,o.useState)(f.n.getData("Correction")),[A,S]=(0,o.useState)("\u041f\u0435\u0440\u0456\u043e\u0434"),L=(0,i.wA)();(0,o.useEffect)((()=>{const e=f.n.getData("Correction");if(e)j(e),L((0,u.iz)(e));else{const e=[s()().startOf("week").format("YYYY-MM-DD"),s()().endOf("week").format("YYYY-MM-DD")],t=new Date(e[0]),n=new Date(e[1]),i=(0,l.Y)(t,n),o=null===i||void 0===i?void 0:i.map((e=>e.valueOf())),r=null===o||void 0===o?void 0:o.map((e=>e.valueOf()));j(r),f.n.setData("Correction",r),r.length>0&&L((0,u.iz)(r))}}),[L]),(0,o.useEffect)((()=>{const t=Array.from(new Set(null===e||void 0===e?void 0:e.map((e=>`${e.teacherName} ${e.teacherSurname}`))));n(t)}),[e]),(0,o.useEffect)((()=>{if(e&&r&&r.length>0){const t=null===e||void 0===e?void 0:e.filter((e=>{const t=`${e.teacherName} ${e.teacherSurname}`;return r.includes(t)}));v(t)}else v(e)}),[e,r]);const D=[{key:1,label:"\u041f\u0430\u0440\u0430\u043c\u0435\u0442\u0440\u0438 \u0432\u0456\u0434\u0431\u043e\u0440\u0443",children:(0,g.jsx)(m.A,{pageName:"Correction",type:A,setType:S,setLessonDates:j,dateCurrentLesson:w,teachers:t,teacher:r,setTeacher:y,onLessonsChange:e=>L((0,u.iz)(e))})}];return(0,g.jsx)(g.Fragment,{children:(0,g.jsxs)(a.A,{children:[(0,g.jsx)(d.A,{currentItems:D}),0===(null===e||void 0===e?void 0:e.length)&&(0,g.jsx)(h.A,{pageName:"\u041a\u043e\u0440\u0435\u043a\u0446\u0456\u0439\u043d\u0438\u0439"}),(0,g.jsx)(c.f,{children:(null===b||void 0===b?void 0:b.length)>0&&(0,g.jsx)(p.A,{lessons:b,onLessonsDelete:e=>L((0,u.Gw)(e._id)),office:"\u041a\u043e\u0440\u0435\u043a\u0446\u0456\u0439\u043d\u0438\u0439"})})]})})}},9615:(e,t,n)=>{n.d(t,{f:()=>i});const i=n(1529).Ay.div`
  width: 100%;
  padding: 5px 5px;
  border-radius: 8px;
  display: flex;
  ...
  gap: 10px;
`}}]);
//# sourceMappingURL=227.986ed6cf.chunk.js.map